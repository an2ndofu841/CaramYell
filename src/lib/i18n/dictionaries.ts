...
export const dictionaries = {
  ja: {
    ...
    detail: {
      ...
      stretchNextPrefix: "努力目標：あと ",
      stretchNextSuffix: " で",
      stretchNextAchieve: "を達成！",
      stretchAllAchieved: "🎉 努力目標もすべて達成しました！",
      stretchTop: "努力目標",
      feesTitle: "手数料について",
      backerFee: "出資者の手数料",
  ...
  en: {
    ...
    detail: {
      ...
      stretchGoals: "Bonus goals",
      stretchGoalsNote:
        "Extra goals placed beyond the final goal. They don't count toward the funding percentage",
      stretchNextPrefix: "Bonus goal: ",
      stretchNextSuffix: " more to unlock ",
      stretchNextAchieve: "!",
      stretchAllAchieved: "🎉 Every bonus goal reached too!",
      stretchTop: "Bonus goal",
