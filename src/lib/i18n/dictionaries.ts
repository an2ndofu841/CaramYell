...
export const dictionaries = {
  ja: {
    ...
    detail: {
      ...
      stretchTop: "ネクストゴール",
      stretchRibbonBadge: "目標突破",
      stretchCardRemaining: "ネクストゴールまで あと ",
      stretchRibbonTitle: "ネクストゴール挑戦中！",
      stretchRibbonSub: "最終目標は達成。さらに先の目標に向けて支援を募集中です",
      feesTitle: "手数料について",
      backerFee: "出資者の手数料",
      ...
      endedDisabled: "募集は終了しました",
      endedNotice: "このプロジェクトの募集期間は終了しました",
      endedBackToProject: "プロジェクトページへ戻る",
    ...
    backing: {
      ...
      freeAmountNote: "100円から。リターンに上乗せ、または単独での応援もできます",
      freeAmountMin: "単独で応援する場合は100円以上を入力してください",
      subtotal: "応援金額 小計",
  ...
  en: {
    ...
    detail: {
      ...
      stretchTop: "Next goal",
      stretchRibbonBadge: "Goal reached",
      stretchCardRemaining: "Next goal: ",
      stretchRibbonTitle: "Now chasing the next goal!",
      stretchRibbonSub: "The final goal is met. Backing is still open for the next goal",
      ...
      endedDisabled: "This campaign has ended",
      endedNotice: "This campaign is no longer accepting support",
      endedBackToProject: "Back to the project page",
    ...
    backing: {
      ...
      freeAmountNote: "From ¥100. Add on top of a reward, or support on its own",
      freeAmountMin: "Enter ¥100 or more to support without a reward",
      subtotal: "Subtotal",
