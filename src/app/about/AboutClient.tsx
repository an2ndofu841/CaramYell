...
const values = [
  ...
  },
  {
    ...
    title: "国境を越える応援",
    description:
      "日本語と英語の切り替えに対応。Apple Pay・Google Payなど多彩な決済手段で、海外からの応援もスムーズに受け付けられます。",
    color: "#A8D8CB",
    bg: "rgba(143, 212, 196, 0.08)",
  },
];
...
const features = [
  ...
  },
  {
    icon: <Bot size={22} />,
    title: "AIプロジェクト作成支援",
    description: "キャッチコピー・説明文・ストーリー本文の下書きをAIが提案",
    color: "#C9A87C",
  },
  {
    icon: <Users size={22} />,
  ...
  },
  {
    icon: <Globe size={22} />,
    title: "海外決済 & 英語表示",
    description: "Apple Pay・Google Payに対応。英語のテキストを登録すれば英語でも表示",
    color: "#FFE0A8",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    a: "支援金はお申し込み時に決済されるため、目標未達を理由とした返金は行われません。掲載者は、集まった資金の範囲で実施できる内容に調整してプロジェクトを進めます。段階ゴールを設定しておくと、達成した段階までを実施する形で運営できます。",
  },
  {
  ...
  {
    q: "海外からの出資も受けられますか？",
    a: `はい。${paymentMethodList("ja")} に対応し、海外発行のカードでも支援を受け付けられます。プロジェクト作成時に英語のテキストを登録しておくと、英語表示に切り替えたときにその内容が表示されます。`,
  },
];
