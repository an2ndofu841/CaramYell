          ...
          <tr>
            <td style="padding:28px;">
              ...
              <p style="margin:0;text-align:center;">
                <a href="{{ .ConfirmationURL }}" style="display:inline-block;background:linear-gradient(135deg,#F2807B,#F5A34B);color:#ffffff;text-decoration:none;font-weight:bold;font-size:15px;padding:13px 34px;border-radius:999px;">${t.buttonLabel}</a>
              </p>

              <p style="margin:22px 0 0;color:#A89685;font-size:12px;line-height:1.8;">
                ボタンが開けない場合は、次のURLをブラウザに貼り付けてください。<br />
                <a href="{{ .ConfirmationURL }}" style="color:#C96A1B;word-break:break-all;">{{ .ConfirmationURL }}</a>
              </p>
